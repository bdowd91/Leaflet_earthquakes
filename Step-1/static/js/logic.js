...
// This function returns the style data for each of the earthquakes plotted on the map. Pass the
// magnitude of the earthquake into two separate functions to calculate the color and radius.
  ...
  L.geoJson(data, {
    ...
    style: styleInfo,
    // We create a popup for each marker to display the magnitude and location of the earthquake after the marker has been create and styled
